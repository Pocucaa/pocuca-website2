<template>
    <div class="flex justify-center items-center h-screen">
        <button v-if="useAppStore().currentEventView != EventView.FOCUSED" @click="useAppStore().setFocusedEventView()"
            type="button" class="btn text-white bg-blue-500 px-4 py-2 rounded-md shadow-lg hover:bg-blue-600">
            Show All PDF
        </button>
